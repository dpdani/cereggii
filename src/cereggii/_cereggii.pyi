...
class AtomicInt(int):
    ...
    def increment_and_get(self, other: int) -> int: ...
    def get_and_increment(self, other: int) -> int: ...
    def decrement_and_get(self, other: int) -> int: ...
    def get_and_decrement(self, other: int) -> int: ...
