...
{ return atomic_fetch_add_explicit((_Atomic(int) *)obj, value, memory_order_acq_rel); }

inline int8_t
CereggiiAtomic_AddInt8(int8_t *obj, int8_t value)
{ return atomic_fetch_add_explicit((_Atomic(int8_t) *)obj, value, memory_order_acq_rel); }

inline int16_t
CereggiiAtomic_AddInt16(int16_t *obj, int16_t value)
{ return atomic_fetch_add_explicit((_Atomic(int16_t) *)obj, value, memory_order_acq_rel); }

inline int32_t
CereggiiAtomic_AddInt32(int32_t *obj, int32_t value)
{ return atomic_fetch_add_explicit((_Atomic(int32_t) *)obj, value, memory_order_acq_rel); }

inline int64_t
CereggiiAtomic_AddInt64(int64_t *obj, int64_t value)
{ return atomic_fetch_add_explicit((_Atomic(int64_t) *)obj, value, memory_order_acq_rel); }

inline intptr_t
CereggiiAtomic_AddIntPtr(intptr_t *obj, intptr_t value)
{ return atomic_fetch_add_explicit((_Atomic(intptr_t) *)obj, value, memory_order_acq_rel); }

inline unsigned int
CereggiiAtomic_AddUInt(unsigned int *obj, unsigned int value)
{ return atomic_fetch_add_explicit((_Atomic(unsigned int) *) obj, value, memory_order_acq_rel); }

inline uint8_t
CereggiiAtomic_AddUInt8(uint8_t *obj, uint8_t value)
{ return atomic_fetch_add_explicit((_Atomic(uint8_t) *)obj, value, memory_order_acq_rel); }

inline uint16_t
CereggiiAtomic_AddUInt16(uint16_t *obj, uint16_t value)
{ return atomic_fetch_add_explicit((_Atomic(uint16_t) *)obj, value, memory_order_acq_rel); }

inline uint32_t
CereggiiAtomic_AddUInt32(uint32_t *obj, uint32_t value)
{ return atomic_fetch_add_explicit((_Atomic(uint32_t) *)obj, value, memory_order_acq_rel); }

inline uint64_t
CereggiiAtomic_AddUInt64(uint64_t *obj, uint64_t value)
{ return atomic_fetch_add_explicit((_Atomic(uint64_t) *)obj, value, memory_order_acq_rel); }

inline uintptr_t
CereggiiAtomic_AddUIntPtr(uintptr_t *obj, uintptr_t value)
{ return atomic_fetch_add_explicit((_Atomic(uintptr_t) *)obj, value, memory_order_acq_rel); }

inline Py_ssize_t
CereggiiAtomic_AddSsize(Py_ssize_t *obj, Py_ssize_t value)
{ return atomic_fetch_add_explicit((_Atomic(Py_ssize_t) *)obj, value, memory_order_acq_rel); }


inline int
CereggiiAtomic_CompareExchangeInt(int *obj, int expected, int desired)
{
    return atomic_compare_exchange_strong_explicit((_Atomic(int) *) obj, &expected, desired, memory_order_acq_rel, memory_order_acquire);
}

inline int
CereggiiAtomic_CompareExchangeInt8(int8_t *obj, int8_t expected, int8_t desired)
{
    return atomic_compare_exchange_strong_explicit((_Atomic(int8_t) *) obj, &expected, desired, memory_order_acq_rel, memory_order_acquire);
}

inline int
CereggiiAtomic_CompareExchangeInt16(int16_t *obj, int16_t expected, int16_t desired)
{
    return atomic_compare_exchange_strong_explicit((_Atomic(int16_t) *) obj, &expected, desired, memory_order_acq_rel, memory_order_acquire);
}

inline int
CereggiiAtomic_CompareExchangeInt32(int32_t *obj, int32_t expected, int32_t desired)
{
    return atomic_compare_exchange_strong_explicit((_Atomic(int32_t) *) obj, &expected, desired, memory_order_acq_rel, memory_order_acquire);
}
...
{
    return atomic_compare_exchange_strong_explicit((_Atomic(intptr_t) *) obj, &expected, desired, memory_order_acq_rel, memory_order_acquire);
}

inline int
CereggiiAtomic_CompareExchangeUInt(unsigned int *obj, unsigned int expected, unsigned int desired)
{
    return atomic_compare_exchange_strong_explicit((_Atomic(unsigned) *) obj, &expected, desired, memory_order_acq_rel, memory_order_acquire);
}

inline int
CereggiiAtomic_CompareExchangeUInt8(uint8_t *obj, uint8_t expected, uint8_t desired)
{
    return atomic_compare_exchange_strong_explicit((_Atomic(uint8_t) *) obj, &expected, desired, memory_order_acq_rel, memory_order_acquire);
}

inline int
CereggiiAtomic_CompareExchangeUInt16(uint16_t *obj, uint16_t expected, uint16_t desired)
{
    return atomic_compare_exchange_strong_explicit((_Atomic(uint16_t) *) obj, &expected, desired, memory_order_acq_rel, memory_order_acquire);
}

inline int
CereggiiAtomic_CompareExchangeUInt32(uint32_t *obj, uint32_t expected, uint32_t desired)
{
    return atomic_compare_exchange_strong_explicit((_Atomic(uint32_t) *) obj, &expected, desired, memory_order_acq_rel, memory_order_acquire);
}
...
{
    return atomic_compare_exchange_strong_explicit((_Atomic(uintptr_t) *) obj, &expected, desired, memory_order_acq_rel, memory_order_acquire);
}

inline int
CereggiiAtomic_CompareExchangeSsize(Py_ssize_t *obj, Py_ssize_t expected, Py_ssize_t desired)
{
    return atomic_compare_exchange_strong_explicit((_Atomic(Py_ssize_t) *) obj, &expected, desired, memory_order_acq_rel, memory_order_acquire);
}

inline int
CereggiiAtomic_CompareExchangePtr(void **obj, void *expected, void *desired)
{
    return atomic_compare_exchange_strong_explicit((_Atomic(void *) *) obj, &expected, desired, memory_order_acq_rel,
...
{ return atomic_exchange_explicit((_Atomic(int) *) obj, value, memory_order_acq_rel); }

inline int8_t
CereggiiAtomic_ExchangeInt8(int8_t *obj, int8_t value)
{ return atomic_exchange_explicit((_Atomic(int8_t) *) obj, value, memory_order_acq_rel); }

inline int16_t
CereggiiAtomic_ExchangeInt16(int16_t *obj, int16_t value)
{ return atomic_exchange_explicit((_Atomic(int16_t) *) obj, value, memory_order_acq_rel); }

inline int32_t
CereggiiAtomic_ExchangeInt32(int32_t *obj, int32_t value)
{ return atomic_exchange_explicit((_Atomic(int32_t) *) obj, value, memory_order_acq_rel); }

inline int64_t
CereggiiAtomic_ExchangeInt64(int64_t *obj, int64_t value)
{ return atomic_exchange_explicit((_Atomic(int64_t) *) obj, value, memory_order_acq_rel); }

inline intptr_t
CereggiiAtomic_ExchangeIntPtr(intptr_t *obj, intptr_t value)
{ return atomic_exchange_explicit((_Atomic(intptr_t) *) obj, value, memory_order_acq_rel); }

inline unsigned int
CereggiiAtomic_ExchangeUInt(unsigned int *obj, unsigned int value)
{ return atomic_exchange_explicit((_Atomic(unsigned int) *) obj, value, memory_order_acq_rel); }

inline uint8_t
CereggiiAtomic_ExchangeUInt8(uint8_t *obj, uint8_t value)
{ return atomic_exchange_explicit((_Atomic(uint8_t) *) obj, value, memory_order_acq_rel); }

inline uint16_t
CereggiiAtomic_ExchangeUInt16(uint16_t *obj, uint16_t value)
{ return atomic_exchange_explicit((_Atomic(uint16_t) *) obj, value, memory_order_acq_rel); }

inline uint32_t
CereggiiAtomic_ExchangeUInt32(uint32_t *obj, uint32_t value)
{ return atomic_exchange_explicit((_Atomic(uint32_t) *) obj, value, memory_order_acq_rel); }

inline uint64_t
CereggiiAtomic_ExchangeUInt64(uint64_t *obj, uint64_t value)
{ return atomic_exchange_explicit((_Atomic(uint64_t) *) obj, value, memory_order_acq_rel); }

inline uintptr_t
CereggiiAtomic_ExchangeUIntPtr(uintptr_t *obj, uintptr_t value)
{ return atomic_exchange_explicit((_Atomic(uintptr_t) *) obj, value, memory_order_acq_rel); }

inline Py_ssize_t
CereggiiAtomic_ExchangeSsize(Py_ssize_t *obj, Py_ssize_t value)
{ return atomic_exchange_explicit((_Atomic(Py_ssize_t) *) obj, value, memory_order_acq_rel); }

inline void *
CereggiiAtomic_ExchangePtr(void **obj, void *value)
{ return atomic_exchange_explicit((_Atomic(void *) *)obj, value, memory_order_acq_rel); }


inline uint8_t
CereggiiAtomic_AndUInt8(uint8_t *obj, uint8_t value)
{ return atomic_fetch_and_explicit((_Atomic(uint8_t) *) obj, value, memory_order_acq_rel); }

inline uint16_t
CereggiiAtomic_AndUInt16(uint16_t *obj, uint16_t value)
{ return atomic_fetch_and_explicit((_Atomic(uint16_t) *) obj, value, memory_order_acq_rel); }

inline uint32_t
CereggiiAtomic_AndUInt32(uint32_t *obj, uint32_t value)
{ return atomic_fetch_and_explicit((_Atomic(uint32_t) *) obj, value, memory_order_acq_rel); }

inline uint64_t
CereggiiAtomic_AndUInt64(uint64_t *obj, uint64_t value)
{ return atomic_fetch_and_explicit((_Atomic(uint64_t) *) obj, value, memory_order_acq_rel); }

inline uintptr_t
CereggiiAtomic_AndUIntPtr(uintptr_t *obj, uintptr_t value)
{ return atomic_fetch_and_explicit((_Atomic(uintptr_t) *) obj, value, memory_order_acq_rel); }


inline uint8_t
CereggiiAtomic_OrUInt8(uint8_t *obj, uint8_t value)
{ return atomic_fetch_or_explicit((_Atomic(uint8_t) *) obj, value, memory_order_acq_rel); }

inline uint16_t
CereggiiAtomic_OrUInt16(uint16_t *obj, uint16_t value)
{ return atomic_fetch_or_explicit((_Atomic(uint16_t) *) obj, value, memory_order_acq_rel); }

inline uint32_t
CereggiiAtomic_OrUInt32(uint32_t *obj, uint32_t value)
{ return atomic_fetch_or_explicit((_Atomic(uint32_t) *) obj, value, memory_order_acq_rel); }

inline uint64_t
CereggiiAtomic_OrUInt64(uint64_t *obj, uint64_t value)
{ return atomic_fetch_or_explicit((_Atomic(uint64_t) *) obj, value, memory_order_acq_rel); }

inline uintptr_t
CereggiiAtomic_OrUIntPtr(uintptr_t *obj, uintptr_t value)
{ return atomic_fetch_or_explicit((_Atomic(uintptr_t) *) obj, value, memory_order_acq_rel); }
...
{ return atomic_load_explicit((_Atomic(int8_t) *) obj, memory_order_acquire); }

inline int16_t
CereggiiAtomic_LoadInt16(const int16_t *obj)
{ return atomic_load_explicit((_Atomic(int16_t) *) obj, memory_order_acquire); }

inline int32_t
CereggiiAtomic_LoadInt32(const int32_t *obj)
{ return atomic_load_explicit((_Atomic(int32_t) *) obj, memory_order_acquire); }

inline int64_t
CereggiiAtomic_LoadInt64(const int64_t *obj)
{ return atomic_load_explicit((_Atomic(int64_t) *) obj, memory_order_acquire); }

inline intptr_t
CereggiiAtomic_LoadIntPtr(const intptr_t *obj)
{ return atomic_load_explicit((_Atomic(intptr_t) *) obj, memory_order_acquire); }

inline uint8_t
CereggiiAtomic_LoadUInt8(const uint8_t *obj)
{ return atomic_load_explicit((_Atomic(uint8_t) *) obj, memory_order_acquire); }

inline uint16_t
CereggiiAtomic_LoadUInt16(const uint16_t *obj)
{ return atomic_load_explicit((_Atomic(uint16_t) *) obj, memory_order_acquire); }
...
{ return atomic_load_explicit((_Atomic(uintptr_t) *) obj, memory_order_acquire); }

inline unsigned int
CereggiiAtomic_LoadUInt(const unsigned int *obj)
{ return atomic_load_explicit((_Atomic(unsigned int) *) obj, memory_order_acquire); }
...
{ atomic_store_explicit((_Atomic(int8_t) *) obj, value, memory_order_release); }

inline void
CereggiiAtomic_StoreInt16(int16_t *obj, int16_t value)
{ atomic_store_explicit((_Atomic(int16_t) *) obj, value, memory_order_release); }

inline void
CereggiiAtomic_StoreInt32(int32_t *obj, int32_t value)
{ atomic_store_explicit((_Atomic(int32_t) *) obj, value, memory_order_release); }

inline void
CereggiiAtomic_StoreInt64(int64_t *obj, int64_t value)
{ atomic_store_explicit((_Atomic(int64_t) *) obj, value, memory_order_release); }

inline void
CereggiiAtomic_StoreIntPtr(intptr_t *obj, intptr_t value)
{ atomic_store_explicit((_Atomic(intptr_t) *) obj, value, memory_order_release); }

inline void
CereggiiAtomic_StoreUInt8(uint8_t *obj, uint8_t value)
{ atomic_store_explicit((_Atomic(uint8_t) *) obj, value, memory_order_release); }

inline void
CereggiiAtomic_StoreUInt16(uint16_t *obj, uint16_t value)
{ atomic_store_explicit((_Atomic(uint16_t) *) obj, value, memory_order_release); }
